...
$kod = isset($_GET['kod']) ? htmlspecialchars($_GET['kod']) : '';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="main-content" id="main">
      <div class="haslo">
        ...
        <form method="GET" action="../test.php">
          ...
          <input class="full-width" type="text" name="kod" id="kod" value="<?php echo $kod; ?>" required>
          <div style="display: flex; padding-left:10%; align-items: center;">
            <label style="padding-left:10%;" for="zaloguj">
              <a href="../kontakt.php">Problem z dołączeniem?</a>
            </label>
          </div>
